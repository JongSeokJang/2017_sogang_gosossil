...
int _tmain(int argc, _TCHAR* argv[])
{
		...
		addWeighted(img1_Mat, alpha, 0, beta, 0, img1_Mat_half);
		/////////////////////////////////////////////////////////////////
		...
		addWeighted(img1_Mat, alpha, 0, beta, 0, img1_Mat_double);
		/////////////////////////////////////////////////////////////////
		...
		cvtColor(img2_Mat, img2_Mat_gray, COLOR_RGB2GRAY);

		cvNamedWindow("problem2_lena_24_gray", 1);
		...
		cvtColor(img3_Mat, img3_Mat_gray, COLOR_RGB2GRAY);

		cvNamedWindow("problem3_image_16_gray", 1);
